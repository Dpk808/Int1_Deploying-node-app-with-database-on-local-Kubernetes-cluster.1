...
<pre lang="markdown"> <code>```text mongo-config.yaml -- one configuration for all pods mongo-secret.yaml -- stores credentials mongo.yaml -- database webapp.yaml -- app ```</code> </pre>
